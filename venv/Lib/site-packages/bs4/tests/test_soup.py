...
<i>\310\322\321\220\312\321\355\344</i></html>"""
    ...
    def test_find_declared_encoding(self):
        ...
        # HTML document.
        self.assertEqual(
            "utf-8", m(spacer + html_bytes, is_html=True, search_entire_document=True)
        )

        # The XML encoding declaration has to be the very first thing
        # in the document. We'll allow whitespace before the document
        # starts, but nothing else.
        self.assertEqual("iso-8859-1", m(xml_bytes, search_entire_document=True))
        self.assertEqual(None, m(b"a" + xml_bytes, search_entire_document=True))
